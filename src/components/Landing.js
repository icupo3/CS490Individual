...
export default function LandingPage() {
    ...
    // TODO: set up router to make this work!
    const pageRedirect = (event) => {
      alert(event.target.innerText);
      // router to page based on event target innertext
    };
    ...
    return (
        <div>
          ...
          <table id='actorDetailsTable' style={{ visibility: actorDetailsVisible ? 'visible' : 'hidden' }}>
            <thead>
            <tr>
              <td className='three-quarters-width' colSpan='2'>Top 5 rented movies of NAME</td>
